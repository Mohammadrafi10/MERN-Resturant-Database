        ...
        <main className="min-h-screen bg-amber-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center py-12">
              <p className="text-amber-900 font-serif text-lg">Loading recipe...</p>
            </div>
          </div>
        </main>
        <Footer />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center py-12">
              <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8 border-2 border-amber-800">
                ...
                <Link
                  to="/recipes"
                  className="inline-block bg-amber-800 text-amber-50 font-serif font-medium py-2 px-6 rounded-md hover:bg-amber-900 transition-colors"
                >
                  Back to Recipes
                </Link>
              </div>
      ...
      <main className="min-h-screen bg-amber-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="mb-6">
            <Link
              to="/recipes"
              className="text-amber-900 font-serif font-medium hover:text-amber-800 transition-colors inline-flex items-center"
            >
              ← Back to Recipes
            </Link>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-amber-800">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between text-amber-700 font-serif">
            ...
            <div className="mb-8">
              ...
              <p className="text-amber-800 font-serif text-lg leading-relaxed whitespace-pre-line">
                {recipe.description}
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2">
                {recipe.ingredients?.map((ingredient, idx) => (
                  <li key={idx} className="text-amber-800 font-serif text-lg">
                    {ingredient}
                  </li>
                ))}
              </ul>
            ...
            <div className="pt-6 border-t border-amber-200">
              <div className="flex items-center justify-between text-sm text-amber-700 font-serif">
                <span>
