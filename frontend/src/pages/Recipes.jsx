        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {loading ? (
            <div className="text-center py-12">
              <p className="text-amber-900 dark:text-amber-200 font-serif text-lg">Loading recipes...</p>
            </div>
          ) : recipes.length === 0 ? (
            <div className="text-center py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredAndSortedRecipes.map((recipe) => (
                <Link
                  ...
                  className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border-2 border-amber-800 dark:border-amber-600 hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  {recipe.imageUrl && (
                    <img
                      src={recipe.imageUrl}
                  ...
                  <div className="mb-4">
                    <span className="inline-block px-3 py-1 bg-amber-200 dark:bg-amber-700 text-amber-900 dark:text-amber-100 font-serif font-medium rounded-full text-sm capitalize mb-2">
